...
python train.py    -s /data/sopio/small_city_50/25 -r 1  -m output/small_city_50/25_1 --config_file config/gaussian_dataset/train.json --iteration 7000

# Segmentation rendering using trained model
python render.py -m output/small_city_50/25_1 --num_classes 2
